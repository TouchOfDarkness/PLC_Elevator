...
IGuiDialogView
{
	...
	IGuiComboBox
	{
		...
		qm_FillColor: "#fff5f5f5"
		qm_TextColor: "#ff13192c"
		qm_Anchors.bottomMargin: 2
		qm_Anchors.leftMargin: 2
		qm_Anchors.rightMargin: 42
		qm_Anchors.topMargin: 2
		qm_FocusWidth: 0
		qm_FocusColor: "#ffffffff"
		qm_GraphicImageId : 6 
		qm_IsDownButtonVisible: true
		qm_SymIOType: 2
		qm_NoOfVisibleRows:4
		qm_HotAreaWidth:40
		qm_SymIOSelBackFillColor: "#ffc9c9f5"
		qm_SymIOAltBackFillColor: "#ffffffff"
		qm_SymIOSelForeColor:"#ff3e414f"
